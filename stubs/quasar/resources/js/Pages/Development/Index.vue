...
<template>
  <q-page padding>
    <q-splitter v-model="splitterModel" style="height: 100%" :limits="[50, 60]">
      <template v-slot:before>
        <q-separator />
        <q-card class="q-mb-sm">
          <q-card-section class="text-h4"
            >Controllers
            <q-badge align="top" color="blue">{{ controllers.length }}</q-badge>
          </q-card-section>
          <q-separator />
          <q-card-section>
            <q-chip
        ...
        <q-card class="q-mb-sm">
          <q-card-section class="text-h4"
            >Models
            <q-badge align="top" color="red">{{ models.length }}</q-badge>
          </q-card-section>
          <q-separator />
          <q-card-section>
            <q-chip
        ...
        <q-card class="q-mb-sm">
          <q-card-section class="text-h4"
            >Resources
            <q-badge color="green" align="top">{{ resources.length }}</q-badge>
          </q-card-section>
          <q-separator />
          <q-card-section>
            <q-chip
        ...
        <q-card class="q-mb-sm">
          <q-card-section class="text-h4"
            >Requests
            <q-badge color="grey" align="top">{{ requests.length }}</q-badge>
          </q-card-section>
          <q-separator />
          <q-card-section>
      ...
      <template v-slot:after>
        <div class="q-ma-md">
          <q-form @submit="onSubmit" @reset="onReset" class="q-gutter-md">
            ...
            >
              <template #after>
                <q-btn flat icon="add" @click="addItem" />
              </template>
            </q-input>
            <q-separator />
